...
const TestStatistics = () => {
  ...
  const totalSkipped = testSuites.reduce((sum, suite) => sum + (suite.skipped || 0), 0);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Statistiques des Tests Laravel</h1>

        {/* Summary Cards */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            <div className="text-sm font-medium text-gray-500 mb-2">Total Tests</div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="text-sm text-gray-500 mt-1">{successRate}% de réussite</div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="text-sm text-gray-500 mt-1">{((totalFailed / totalTests) * 100).toFixed(1)}%</div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="text-sm text-gray-500 mt-1">{((totalSkipped / totalTests) * 100).toFixed(1)}%</div>
          </div>
        </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 truncate">{suite.name}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-6 ml-4">
                      <div className="text-right">
                        ...
                        <div className="text-xs text-gray-500">{suiteSuccessRate}%</div>
                      </div>
